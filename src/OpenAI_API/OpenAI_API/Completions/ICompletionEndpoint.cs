...
namespace OpenAI_API.Completions
{
	...
	public interface ICompletionEndpoint
    {
        ...
        Task<CompletionResult> CreateCompletionAsync(CompletionRequest request, CancellationToken cancel = default);
        ...
        Task<CompletionResult> CreateCompletionsAsync(CompletionRequest request, int numOutputs = 5, CancellationToken cancel = default);
        ...
        Task StreamCompletionAsync(CompletionRequest request, Action<int, CompletionResult> resultHandler, CancellationToken cancel = default);
        ...
        Task StreamCompletionAsync(CompletionRequest request, Action<CompletionResult> resultHandler, CancellationToken cancel = default);
        ...
        IAsyncEnumerable<CompletionResult> StreamCompletionEnumerableAsync(CompletionRequest request, CancellationToken cancel = default);
