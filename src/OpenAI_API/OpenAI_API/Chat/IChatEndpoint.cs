...
namespace OpenAI_API.Chat
{
	...
	public interface IChatEndpoint
	{
		...
		Task<ChatResult> CreateChatCompletionAsync(ChatRequest request, CancellationToken cancel);
		...
		/// <returns>Asynchronously returns the completion result. Look in its <see cref="ChatResult.Choices"/> property for the results.</returns>
		Task<ChatResult> CreateChatCompletionAsync(ChatRequest request, int numOutputs = 5, CancellationToken cancel = default);
		...
		IAsyncEnumerable<ChatResult> StreamChatEnumerableAsync(ChatRequest request, CancellationToken cancel = default);
