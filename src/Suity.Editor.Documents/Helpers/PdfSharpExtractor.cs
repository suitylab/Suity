...
/// </summary>
public class PdfSharpExtractor : IDisposable
{


    /// <summary>
    /// Converts a PDF file to text asynchronously.
    /// </summary>
    ...
    public static string PdfToText(string file)
    {
        ...
        {
            PdfSharpExtractor ext = new PdfSharpExtractor(_document);
    ...
    /// <summary>
    /// Gets the PDF document being processed.
    /// </summary>
    internal PdfDocument Document { get; }

    /// <summary>
    /// Initializes a new instance of the <see cref="PdfSharpExtractor"/> class.
    /// </summary>
    /// <param name="doc">The PDF document to extract text from.</param>
    public PdfSharpExtractor(PdfDocument doc)
    {
        Document = doc;
    }
    ...
    /// <summary>
    /// Represents font information extracted from a PDF document.
    /// </summary>
    internal class Font
    {
        PdfDictionary font;
        /// <summary>
        /// Enumerates the supported PDF font types.
        /// </summary>
        ...
        /// </summary>
        /// <param name="val">The character code to convert.</param>
        /// <returns>The Unicode string, or empty string if not found.</returns>
        ...
        /// <summary>
        /// Gets a value indicating whether this font uses two-byte encoding.
        /// </summary>
        public bool IsTwoByte { get; }

        /// <summary>
        /// Initializes a new instance of the <see cref="Font"/> class from a PDF dictionary.
        /// </summary>
        /// <param name="dictionary">The PDF font dictionary.</param>
        ...
        /// <summary>
        /// Gets or sets the default character used when no mapping is found.
        /// </summary>
        ...
        /// <summary>
        /// Processes a PDF string and extracts its text content.
        /// </summary>
        /// <param name="str">The PDF string to process.</param>
        /// <returns>The extracted text (currently returns empty string).</returns>
    ...
    /// <param name="res">The string builder to append extracted text to.</param>
            ...
            if (obj.Operands.Count == 1)
            {
                if (obj.Operands[0] is CArray)
                {
                    foreach (var elem in ((CArray)(obj.Operands[0])))
                    {
                        ...
                        else if (elem is CInteger i && i.Value < 0)
                        {
                            target.Append(' ');
                        }
                        else
    ...
    /// <summary>
    /// Provides standard PDF encoding tables for character mapping.
    /// </summary>
    internal static class EncodingTables
    {
        /// <summary>
        /// Represents a null/missing character in encoding tables.
        /// </summary>
        public const string NULL = null;

        /// <summary>
        /// Converts an encoding string array to a character mapping dictionary.
        /// </summary>
        /// <param name="encoding">The encoding array to convert.</param>
        /// <returns>A dictionary mapping character codes to Unicode strings.</returns>
...
"ydieresis"
    ...
    static string[] standardEncoding = {
NULL,
NULL,
NULL,
NULL,
...
NULL
    ...
    static string[] zapfDingbatsEncoding = {
NULL,
NULL,
NULL,
NULL,
