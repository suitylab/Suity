...
/// </summary>
[DocumentFormat(FormatName = "AigcFlow", Extension = "aigcflow", DisplayText = "Workflow", Icon = "*CoreIcon|Workflow", Categoty = "AIGC", Order = 100, Iteration = LoadingIterations.Iteration2)]
