...
";
    ...
    /// <summary>
    /// Gets or sets the maximum number of chat history entries to keep in context. A value of 0 or less means unlimited.
    /// </summary>
    public int MaxChatHistory => _maxChatHistory.Value;

    /// <summary>
    /// Gets or sets the maximum number of scratch pad entries to keep in context. A value of 0 or less means unlimited.
    /// </summary>
