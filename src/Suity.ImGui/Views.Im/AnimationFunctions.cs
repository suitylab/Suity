...
/// <summary>
///     Enumerates all known animation easing functions.
/// </summary>
public enum KnownAnimationFunctions
{
    /// <summary>
    ///     Indicates that no animation easing function is applied.
    /// </summary>
    None,
...
/// <summary>
///     Provides a collection of static animation easing functions.
/// </summary>
public static class AnimationFunctions
{
    /// <summary>
    ///     Delegate representing an animation easing function.
    /// </summary>
    /// <param name="time">
    ...
    ///     The difference between starting and ending value.
    /// </param>
    /// <param name="duration">
    ...
    /// <summary>
    ///     Returns an animation function delegate corresponding to the specified known easing function.
    /// </summary>
