...
/// <summary>
/// Base class for design nodes in the editor.
/// </summary>
/// <summary>
/// Base class for design nodes in the editor.
/// </summary>
public abstract class DesignNode : SNamedNode,
    ...
    IHasToolTips
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="DesignNode"/> class.
    /// </summary>
    protected DesignNode()
    { }

    /// <summary>
    /// Initializes a new instance of the <see cref="DesignNode"/> class with the specified builder.
    /// </summary>
    protected DesignNode(AssetBuilder builder)
        : base(builder)
    {
    ...
    /// <summary>
    /// Gets or sets the access mode for this node.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the instance mode for this node.
    /// </summary>
    ...
    protected override Color? OnGetColor() => this.Color.ToNullable();
    ...
    /// <summary>
    /// Gets or sets the icon selection for this node.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the icon ID for this node.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the icon key for this node.
    /// </summary>
    ...
    protected virtual object OnRedirectedObject(int viewIndex)
    {
        return this;
    }
    ...
    object IViewRedirect.GetRedirectedObject(int viewId) => OnRedirectedObject(viewId);
    ...
    public virtual bool OnEditorGui(ImGui gui, EditorImGuiPipeline pipeline, IDrawContext context)
    {
        if (pipeline == EditorImGuiPipeline.Preview)
        {
            ...
            if (!string.IsNullOrWhiteSpace(preview))
            {
                ...
                .InitClass("refBox")
                .OverrideColor(OnGetColor())
                .OnContent(() =>
                {
                    var icon = this.OnGetIcon();
                    if (icon != null)
                    {
    ...
    protected override void OnSync(IPropertySync sync, ISyncContext context)
    {
        ...
        Description = sync.Sync("Description", _description, SyncFlag.NotNull);
        IconSelection = sync.Sync("Icon", _iconSelection, SyncFlag.NotNull);
...
/// <summary>
/// Generic base class for design nodes with a specific asset builder type.
/// </summary>
/// <typeparam name="TAssetBuilder">The type of asset builder.</typeparam>
public abstract class DesignNode<TAssetBuilder> : DesignNode
        where TAssetBuilder : AssetBuilder, new()
{
    private readonly TAssetBuilder _builder;

    /// <summary>
    /// Initializes a new instance of the <see cref="DesignNode{TAssetBuilder}"/> class.
    /// </summary>
    protected DesignNode()
    ...
    /// <summary>
    /// Gets the asset builder for this node.
    /// </summary>
