...
public class Pool<T> where T : class
{
    ...
    /// <summary>
    /// Initializes a new instance of the Pool class with a factory function.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the Pool class with a factory function and a maximum capacity.
    /// </summary>
    /// <param name="factory">The factory function used to create new objects.</param>
