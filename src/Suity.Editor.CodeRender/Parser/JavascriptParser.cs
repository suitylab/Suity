...
public class JavaScriptParser
{
    ...
    private static readonly HashSet<string> StrictModeReservedWords =
    [
        "implements",
        "interface",
        "package",
    ...
    private static readonly HashSet<string> FutureReservedWords =
    [
        "class",
        "enum",
        "export",
    ...
    private readonly Stack<IVariableScope> _variableScopes = [];
    private readonly Stack<IFunctionScope> _functionScopes = [];
    ...
    private Token ScanNumericLiteral()
    {
        ...
        {
            n = StringTrim.TrimEx(number).StartsWith("-") ? double.NegativeInfinity : double.PositiveInfinity;
        }
        catch (Exception)
        {
            n = double.NaN;
    ...
    private Token Lex()
    {
        ...
        _lineNumber = token.LineNumber ?? 0;
    ...
    public BlockStatement CreateBlockStatement(IEnumerable<StatementNode> body)
    {
    ...
    public DoWhileStatement CreateDoWhileStatement(StatementNode body, Expression test)
    {
    ...
    public ForStatement CreateForStatement(SyntaxNode init, Expression test, Expression update, StatementNode body)
    {
    ...
    public ForInStatement CreateForInStatement(SyntaxNode left, Expression right, StatementNode body)
    {
    ...
    public FunctionDeclaration CreateFunctionDeclaration(Identifier id, IEnumerable<Identifier> parameters,
                                                         IEnumerable<Expression> defaults, StatementNode body, bool strict)
    {
    ...
    public IfStatement CreateIfStatement(Expression test, StatementNode consequent, StatementNode alternate)
    {
    ...
    public LabelledStatement CreateLabeledStatement(Identifier label, StatementNode body)
    {
    ...
    public Program CreateProgram(ICollection<StatementNode> body, bool strict)
    {
        return new Program
            {
    ...
    public SwitchCase CreateSwitchCase(Expression test, IEnumerable<StatementNode> consequent)
    {
    ...
    public TryStatement CreateTryStatement(StatementNode block, IEnumerable<StatementNode> guardedHandlers,
                                           IEnumerable<CatchClause> handlers, StatementNode finalizer)
    {
    ...
    public WhileStatement CreateWhileStatement(Expression test, StatementNode body)
    {
    ...
    public WithStatement CreateWithStatement(Expression obj, StatementNode body)
    {
    ...
    private void ThrowError(Token token, string messageFormat, params object[] arguments)
    {
        ...
        if (token?.LineNumber.HasValue == true)
        {
    ...
    private FunctionExpression ParsePropertyFunction(Identifier[] parameters, Token first = null)
    {
        ...
        MarkStart();
        StatementNode body = ParseFunctionSourceElements();
    ...
    private IEnumerable<StatementNode> ParseStatementList()
    {
        ...
        while (_index < _length)
        {
            ...
            StatementNode statement = ParseSourceElement();
            if (statement == null)
            {
                break;
            }
    ...
    private BlockStatement ParseBlock()
    {
        ...
        IEnumerable<StatementNode> block = ParseStatementList();
    ...
    private IfStatement ParseIfStatement()
    {
        ...
        StatementNode consequent = ParseStatement();
    ...
    private StatementNode ParseForStatement()
    {
        ...
        return (left == null)
                   ? (StatementNode) CreateForStatement(init, test, update, body)
    ...
    private TryStatement ParseTryStatement()
    {
        ...
        return CreateTryStatement(block, new StatementNode[0], handlers, finalizer);
    }
    ...
    private StatementNode ParseStatement()
    {
        ...
        if ((expr.Type == SyntaxNodes.Identifier) && Match(":"))
        {
            ...
            StatementNode labeledBody = ParseStatement();
    ...
    private StatementNode ParseFunctionSourceElements()
    {
        Token firstRestricted = Token.Empty;

        var sourceElements = new List<StatementNode>();
        ...
        while (_index < _length)
        {
            ...
            StatementNode sourceElement = ParseSourceElement();
    ...
    private StatementNode ParseSourceElement()
    {
    ...
    private ICollection<StatementNode> ParseSourceElements()
    {
        var sourceElements = new List<StatementNode>();
        Token firstRestricted = Token.Empty;
        StatementNode sourceElement;
    ...
    private Program ParseProgram()
    {
        ...
        MarkStart();
        Peek();
        ICollection<StatementNode> body = ParseSourceElements();
