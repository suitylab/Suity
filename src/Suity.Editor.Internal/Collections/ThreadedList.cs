...
/// <summary>
/// A thread-safe list that uses reader-writer locks to allow concurrent read access
...
public class ThreadedList<T> : IList<T>
{
    ...
    /// <summary>
    /// Initializes a new empty instance of the <see cref="ThreadedList{T}"/> class.
    /// </summary>
    public ThreadedList()
    {
        m_TList = new List<T>();
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ThreadedList{T}"/> class with the specified initial capacity.
    /// </summary>
    /// <param name="capacity">The number of elements the list can initially store.</param>
    public ThreadedList(int capacity)
    {
        m_TList = new List<T>(capacity);
    }

    /// <summary>
    /// Initializes a new instance of the <see cref="ThreadedList{T}"/> class with elements copied from the specified collection.
    /// </summary>
    ...
    /// <summary>
    /// Implicitly converts a <see cref="List{T}"/> to a <see cref="ThreadedList{T}"/>.
    /// </summary>
    /// <param name="value">The list to convert.</param>
    /// <returns>A new <see cref="ThreadedList{T}"/> containing the elements from the source list.</returns>
    public static implicit operator ThreadedList<T>(List<T> value)
    {
        return new ThreadedList<T>(value);
    }
    ...
    /// <summary>
    /// Releases all resources used by the <see cref="ThreadedList{T}"/>.
    /// </summary>
    public void Dispose()
    {
        Dispose(true);
    ...
    /// </summary>
    /// <param name="disposing">If <c>true</c>, dispose managed resources; otherwise, dispose only unmanaged resources.</param>
    ...
    /// <summary>
    /// Finalizes an instance of the <see cref="ThreadedList{T}"/> class.
    /// </summary>
    ~ThreadedList()
    {
