...
public class Crc32Algorithm : HashAlgorithm
{
    ...
    /// <summary>
    /// Computes the CRC-32 checksum of the specified file.
    /// </summary>
    /// <param name="fileName">The path to the file to compute the checksum for.</param>
    /// <returns>The CRC-32 checksum as a UInt32, or 0 if the file does not exist.</returns>
    ...
    protected override byte[] HashFinal()
    {
        ...
        return [(byte)(_currentCrc >> 24), (byte)(_currentCrc >> 16), (byte)(_currentCrc >> 8), (byte)_currentCrc];
    }
...
/// <summary>
/// Internal proxy class that performs the actual CRC-32 computation using a precomputed lookup table.
/// Uses a 16-bit table optimization for faster processing of large data blocks.
/// </summary>
internal class SafeProxy
{
    ...
    /// <summary>
    /// Computes the CRC-32 checksum for the specified byte range using the precomputed lookup table.
    /// </summary>
