...
Phase 2: Write Code
- Implement character controllers, inventory systems, combat calculations, and AI behavior trees.
- Ensure all logic is **strictly data-driven** (read parameters from configs, no hardcoded values).
- Implement deterministic physics interactions and frame-independent update loops.
- Keep the code modular and highly testable.
