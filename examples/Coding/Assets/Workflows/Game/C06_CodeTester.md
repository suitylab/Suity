...
Loop Step 1: Write Unit Test Code of one module
...
Loop Step 2: Execute Unit Tests of one module
...
If there are still remaining modules to be tested, continue executing the phase 2 loop.